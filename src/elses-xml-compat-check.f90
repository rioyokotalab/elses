...
!
    call check_xml_compat_mpi_is_active
!
...
!
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccc
  subroutine check_xml_compat_mpi_is_active
    implicit none
!
...
!
    if (nprocs .ne. 1) then
      if (config%calc%mode == 'matrix_generation') then
        write(*,*)'ERROR:matrix_generation mode is not comatible'
        write(*,*)'       to MPI calculation with multiple nodes'
        stop
      endif
    endif
!
  end subroutine check_xml_compat_mpi_is_active
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccc
