...
!
   subroutine elses_ini_set_velocity
     ...
     use elses_mod_thermo,       only : thb,thbold,vhb,vhbold   !(CHANGED!)
     implicit none
...
!
     if (motion_type == "dynamics") then 
       ...
       thb=0.0d0     !dummy variable
       thbold=0.0d0  !dummy variable
       vhb=0.0d0     !dummy variable
       vhbold=0.0d0  !dummy variable
       if (i_verbose >= 1) then 
